  ...
  return (
    <main className="min-h-screen bg-[#1B2A4A] text-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <div className="mb-12">
          <div className="text-xs font-bold tracking-[0.25em] uppercase text-[#E8A020] mb-3">Legal</div>
          <h1 className="text-4xl font-black mb-4">Terms of Service<br/><span className="text-[#E8A020]">& Privacy Policy</span></h1>
          <p className="text-gray-400">Effective Date: March 28, 2026</p>
        </div>
        <section className="mb-12">
          <h2 className="text-2xl font-black mb-6 pb-3 border-b border-[#E8A020]/30">Terms of Service</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-black mb-6 pb-3 border-b border-[#E8A020]/30">Privacy Policy</h2>
          <div className="space-y-6 text-gray-300 leading-relaxed">
            ...
            <div><h3 className="text-lg font-bold text-white mb-2">6. Contact Us</h3>
              <div className="mt-3 bg-[#162238] rounded-lg p-4 border border-[#E8A020]/20">
                <p className="font-bold text-white">Crest Sales Suite</p>
                <p>Email: <a href="mailto:shawn@crestsalessuite.com" className="text-[#E8A020] hover:underline">shawn@crestsalessuite.com</a></p>
                <p>Website: <a href="https://crestsalessuite.com" className="text-[#E8A020] hover:underline">crestsalessuite.com</a></p>
              </div>
            </div>
          </div>
        </section>
        <div className="pt-8 border-t border-gray-800 text-center">
          ...
          <a href="/" className="text-[#E8A020] text-sm hover:underline mt-2 inline-block">← Back to QuoteVault</a>
        </div>
      </div>
    </main>
  );
