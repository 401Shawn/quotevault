  ...
  return (
    <main className="min-h-screen bg-[#1B2A4A] text-white">
      <div className="bg-[#162238] border-b-2 border-[#E8A020] px-6 py-3 flex items-center justify-between">
        <a href="/" className="font-black text-lg tracking-widest uppercase hover:opacity-80 transition-opacity">Quote<span className="text-[#E8A020]">Vault</span></a>
        <div className="text-xs text-gray-500 tracking-widest uppercase">Crest Sales Suite</div>
      </div>
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <div className="text-xs font-bold tracking-[0.25em] uppercase text-[#E8A020] mb-3">Pricing</div>
          <h1 className="text-4xl font-black mb-4">Simple pricing.<br/><span className="text-[#E8A020]">No surprises.</span></h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-[#162238] border border-gray-700 rounded-xl p-6">
            ...
            <a href="/" className="mt-8 block text-center border border-gray-600 hover:border-[#E8A020] text-gray-400 hover:text-white font-bold text-sm py-3 rounded-lg uppercase tracking-widest transition-all">Get Started Free</a>
          </div>

          {/* Pro */}
          <div className="bg-[#162238] border-2 border-[#E8A020] rounded-xl p-6 relative">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#E8A020] text-[#162238] text-xs font-black px-4 py-1 rounded-full uppercase tracking-widest whitespace-nowrap">Most Popular</div>
            <div className="mb-6">
            ...
            <a href="https://buy.stripe.com/aFa3cx1yzazfdO12hYf7i00" className="mt-8 block text-center bg-[#E8A020] hover:bg-[#C4952A] text-[#162238] font-black text-sm py-3 rounded-lg uppercase tracking-widest transition-all">Get Pro — $9/mo</a>
          </div>
          ...
          <div className="bg-[#162238] border border-gray-700 rounded-xl p-6">
            ...
            <a href="https://buy.stripe.com/28E28t0uv6iZ7pD5uaf7i01" className="mt-8 block text-center border border-gray-600 hover:border-[#E8A020] text-gray-400 hover:text-white font-bold text-sm py-3 rounded-lg uppercase tracking-widest transition-all">Contact for Team Plan</a>
          </div>
        ...
        <div className="text-center">
          ...
          <a href="mailto:shawn@crestsalessuite.com" className="text-[#E8A020] hover:underline text-sm">shawn@crestsalessuite.com</a>
        </div>
